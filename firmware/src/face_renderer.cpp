...
void FaceRenderer::init(TFT_eSPI* tft) {
    ...
    // Buffer DMA : 1/8 d'écran (~19KB) - bon compromis vitesse/RAM
    _buf1 = (lv_color_t*)heap_caps_malloc(SCR_W * 30 * sizeof(lv_color_t), MALLOC_CAP_DMA);
    ...
    lv_disp_draw_buf_init(_draw_buf, _buf1, NULL, SCR_W * 30);
